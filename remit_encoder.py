...
# leaderboard_dataset = pd.read_csv('D:/PYTHON/Dataset/ESUNBANK_Challenge/public_x_alert_date.csv')

#for mac
remit = pd.read_csv('/Users/huanghui-chu/Documents/python/dataset/ESUNBANK_Challenge/public_train_x_remit1_full_hashed.csv')
...
def remit_public_preprocessing(dataset):
...
data = remit_public_preprocessing(leaderboard_dataset)
data.to_csv('remit_public_dataset.csv', index=False)
